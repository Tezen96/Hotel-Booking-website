...
if (isset($_POST['submit'])) {
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO room (name, description, image, facilities, features, price, availability, status, action ) VALUES ('{$name}', '{$description}', '{$image}', '{$facilities}', '{$features}', '{$price}', 1, 0, 0 )";
